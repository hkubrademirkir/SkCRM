...
namespace CRMSporKulubu.WinUI.LoginUI
{
    public partial class KullaniciGiris : Form
    {
        ...
        public static Iletisim _girisYapanKullanciIletisim;

        GirisIslemleri girisYapanKullaniciGizliSoru;
        public static GirisIslemleri _girisYapanKullaniciGizliSoru;
