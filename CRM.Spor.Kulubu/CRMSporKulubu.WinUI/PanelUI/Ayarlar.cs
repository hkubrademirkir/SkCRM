...
namespace CRMSporKulubu.WinUI.PanelUI
{
	public partial class Ayarlar : Form
	{
		...
		public void GizliSoruDoldur()
		{
			...
			girisIslemleri = _girisIslemleriService.GirisBilgileriGetir(KullaniciGiris._girisYapanKullanici.ID);
			cmbGizliSoru.SelectedIndex = girisIslemleri.GizliSoruID - 1;  
		}
